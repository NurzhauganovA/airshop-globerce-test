...
# Source: app/graphql/schema.graphql
...
class AttributeValueWhereInput(BaseModel):
    ...
    and_: Optional[List["AttributeValueWhereInput"]] = Field(alias="AND", default=None)
    or_: Optional[List["AttributeValueWhereInput"]] = Field(alias="OR", default=None)
...
class AssignedAttributeReferenceInput(BaseModel):
    referenced_ids: Optional["ContainsFilterInput"] = Field(
        alias="referencedIds", default=None
    )
    page_slugs: Optional["ContainsFilterInput"] = Field(alias="pageSlugs", default=None)
    product_slugs: Optional["ContainsFilterInput"] = Field(
        alias="productSlugs", default=None
    )
    product_variant_skus: Optional["ContainsFilterInput"] = Field(
        alias="productVariantSkus", default=None
    )


class ContainsFilterInput(BaseModel):
    contains_any: Optional[List[str]] = Field(alias="containsAny", default=None)
    contains_all: Optional[List[str]] = Field(alias="containsAll", default=None)
...
class AddressInput(BaseModel):
    ...
    skip_validation: Optional[bool] = Field(alias="skipValidation", default=False)
...
class PageWhereInput(BaseModel):
    ...
    ids: Optional[List[str]] = None
    slug: Optional["StringFilterInput"] = None
    page_type: Optional["GlobalIDFilterInput"] = Field(alias="pageType", default=None)
    attributes: Optional[List["AssignedAttributeWhereInput"]] = None
    and_: Optional[List["PageWhereInput"]] = Field(alias="AND", default=None)
    or_: Optional[List["PageWhereInput"]] = Field(alias="OR", default=None)
...
class OrderWhereInput(BaseModel):
    ...
    channel_id: Optional["GlobalIDFilterInput"] = Field(alias="channelId", default=None)
    created_at: Optional["DateTimeRangeInput"] = Field(alias="createdAt", default=None)
    updated_at: Optional["DateTimeRangeInput"] = Field(alias="updatedAt", default=None)
    user: Optional["GlobalIDFilterInput"] = None
    user_email: Optional["StringFilterInput"] = Field(alias="userEmail", default=None)
    authorize_status: Optional["OrderAuthorizeStatusEnumFilterInput"] = Field(
        alias="authorizeStatus", default=None
    )
    charge_status: Optional["OrderChargeStatusEnumFilterInput"] = Field(
        alias="chargeStatus", default=None
    )
    status: Optional["OrderStatusEnumFilterInput"] = None
    checkout_token: Optional["UUIDFilterInput"] = Field(
        alias="checkoutToken", default=None
    )
    checkout_id: Optional["GlobalIDFilterInput"] = Field(
        alias="checkoutId", default=None
    )
    is_click_and_collect: Optional[bool] = Field(
        alias="isClickAndCollect", default=None
    )
    is_gift_card_used: Optional[bool] = Field(alias="isGiftCardUsed", default=None)
    is_gift_card_bought: Optional[bool] = Field(alias="isGiftCardBought", default=None)
    voucher_code: Optional["StringFilterInput"] = Field(
        alias="voucherCode", default=None
    )
    has_invoices: Optional[bool] = Field(alias="hasInvoices", default=None)
    invoices: Optional[List["InvoiceFilterInput"]] = None
    has_fulfillments: Optional[bool] = Field(alias="hasFulfillments", default=None)
    fulfillments: Optional[List["FulfillmentFilterInput"]] = None
    lines: Optional[List["LinesFilterInput"]] = None
    lines_count: Optional["IntFilterInput"] = Field(alias="linesCount", default=None)
    transactions: Optional[List["TransactionFilterInput"]] = None
    total_gross: Optional["PriceFilterInput"] = Field(alias="totalGross", default=None)
    total_net: Optional["PriceFilterInput"] = Field(alias="totalNet", default=None)
    product_type_id: Optional["GlobalIDFilterInput"] = Field(
        alias="productTypeId", default=None
    )
    ...
    shipping_address: Optional["AddressFilterInput"] = Field(
        alias="shippingAddress", default=None
    )
    and_: Optional[List["OrderWhereInput"]] = Field(alias="AND", default=None)
    or_: Optional[List["OrderWhereInput"]] = Field(alias="OR", default=None)


class IntFilterInput(BaseModel):
    eq: Optional[int] = None
    one_of: Optional[List[int]] = Field(alias="oneOf", default=None)
...
class OrderAuthorizeStatusEnumFilterInput(BaseModel):
    ...
    one_of: Optional[List[OrderAuthorizeStatusEnum]] = Field(
        alias="oneOf", default=None
    )


class OrderChargeStatusEnumFilterInput(BaseModel):
    eq: Optional[OrderChargeStatusEnum] = None
    one_of: Optional[List[OrderChargeStatusEnum]] = Field(alias="oneOf", default=None)


class OrderStatusEnumFilterInput(BaseModel):
    eq: Optional[OrderStatus] = None
    one_of: Optional[List[OrderStatus]] = Field(alias="oneOf", default=None)
...
class FulfillmentStatusEnumFilterInput(BaseModel):
    ...
    one_of: Optional[List[FulfillmentStatus]] = Field(alias="oneOf", default=None)


class FulfillmentWarehouseFilterInput(BaseModel):
    id: Optional["GlobalIDFilterInput"] = None
    slug: Optional["StringFilterInput"] = None
    external_reference: Optional["StringFilterInput"] = Field(
...
class TransactionFilterInput(BaseModel):
    payment_method_details: Optional["PaymentMethodDetailsFilterInput"] = Field(
...
class PaymentMethodTypeEnumFilterInput(BaseModel):
    ...
    one_of: Optional[List[PaymentMethodTypeEnum]] = Field(alias="oneOf", default=None)
...
class OrderEventTypeEnumFilterInput(BaseModel):
    ...
    one_of: Optional[List[OrderEventsEnum]] = Field(alias="oneOf", default=None)


class AddressFilterInput(BaseModel):
    phone_number: Optional["StringFilterInput"] = Field(
...
class CountryCodeEnumFilterInput(BaseModel):
    ...
    one_of: Optional[List[CountryCode]] = Field(alias="oneOf", default=None)
    not_one_of: Optional[List[CountryCode]] = Field(alias="notOneOf", default=None)
...
class DraftOrderWhereInput(BaseModel):
    ...
    and_: Optional[List["DraftOrderWhereInput"]] = Field(alias="AND", default=None)
    or_: Optional[List["DraftOrderWhereInput"]] = Field(alias="OR", default=None)
...
class CustomerWhereInput(BaseModel):
    ...
    first_name: Optional["StringFilterInput"] = Field(alias="firstName", default=None)
    last_name: Optional["StringFilterInput"] = Field(alias="lastName", default=None)
    is_active: Optional[bool] = Field(alias="isActive", default=None)
    date_joined: Optional["DateTimeRangeInput"] = Field(
        alias="dateJoined", default=None
    )
    updated_at: Optional["DateTimeRangeInput"] = Field(alias="updatedAt", default=None)
    placed_orders_at: Optional["DateTimeRangeInput"] = Field(
        alias="placedOrdersAt", default=None
    )
    addresses: Optional["AddressFilterInput"] = None
    number_of_orders: Optional["IntFilterInput"] = Field(
        alias="numberOfOrders", default=None
    )
    and_: Optional[List["CustomerWhereInput"]] = Field(alias="AND", default=None)
    or_: Optional[List["CustomerWhereInput"]] = Field(alias="OR", default=None)
...
class TaxConfigurationUpdateInput(BaseModel):
    ...
    use_weighted_tax_for_shipping: Optional[bool] = Field(
        alias="useWeightedTaxForShipping", default=None
    )
...
class ProductVariantChannelListingAddInput(BaseModel):
    ...
    prior_price: Optional[Any] = Field(alias="priorPrice", default=None)
...
class TransactionCreateInput(BaseModel):
    ...
    payment_method_details: Optional["PaymentMethodDetailsInput"] = Field(
        alias="paymentMethodDetails", default=None
    )
...
class CardPaymentMethodDetailsInput(BaseModel):
    ...
    first_digits: Optional[str] = Field(alias="firstDigits", default=None)
    last_digits: Optional[str] = Field(alias="lastDigits", default=None)
    exp_month: Optional[int] = Field(alias="expMonth", default=None)
    exp_year: Optional[int] = Field(alias="expYear", default=None)
...
class DraftOrderCreateInput(BaseModel):
    ...
    save_billing_address: Optional[bool] = Field(
        alias="saveBillingAddress", default=None
    )
    user: Optional[str] = None
    ...
    save_shipping_address: Optional[bool] = Field(
        alias="saveShippingAddress", default=None
    )
...
class OrderSettingsInput(BaseModel):
    ...
    draft_order_line_price_freeze_period: Optional[Any] = Field(
        alias="draftOrderLinePriceFreezePeriod", default=None
    )
    use_legacy_line_discount_propagation: Optional[bool] = Field(
        alias="useLegacyLineDiscountPropagation", default=None
    )
